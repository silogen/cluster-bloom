...
func TestLoadSchema(t *testing.T) {
	...
	// Check that we have expected number of fields (32 fields in schema including CLUSTER_SIZE and CLUSTER_LISTEN_IP)
	if len(args) != 32 {
		t.Errorf("Expected 32 arguments, got %d", len(args))
	}
