...
func init() {
	...
	SetArguments([]Arg{
		...
		{Key: "TLS_SAN", Default: "", Description: "Additional Subject Alternative Names (SANs) to add to the TLS certificate. Comma-separated list of IPs or DNS names.", Type: "string", Dependencies: "FIRST_NODE=true", Validators: []func(value string) error{args.ValidateListOfHostnames}},
