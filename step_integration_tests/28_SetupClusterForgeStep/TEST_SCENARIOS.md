# SetupClusterForgeStep Integration Tests
...
./cluster-bloom cli --config step_integration_tests/28_SetupClusterForgeStep/01-basic-success/config.yaml \
                    --dry-run \
                    --dry-run-mocks step_integration_tests/28_SetupClusterForgeStep/01-basic-success/mocks.yaml
```
